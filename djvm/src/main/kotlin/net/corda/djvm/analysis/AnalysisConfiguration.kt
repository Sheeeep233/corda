...
class AnalysisConfiguration(
    ...
    fun isMandatoryBase(className: String): Boolean = MANDATORY_BASE_CLASSES.contains(className)
    fun isStitchedClass(className: String): Boolean = STITCHED_CLASSES.contains(className)
    fun isRequiredUnmodified(className: String): Boolean = className in pinnedClasses || MANDATORY_BASE_CLASSES.contains(className)
    ...
    companion object {
        ...
        private val MANDATORY_PINNED_CLASSES: Set<String> = setOf(
            ...
            sandbox.java.lang.Void::class.java
        ...
        val MANDATORY_BASE_CLASSES: Set<String> = setOf(
